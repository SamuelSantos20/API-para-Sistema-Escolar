...
public class NotaImpl extends AbstractDao<Nota,Long > implements NotaDao{
	...
	public List<Nota> NotasAluno(Long id) {
	    try {
	        // Corrigido para usar a entidade Nota diretamente com FETCH JOIN para evitar N+1 queries
	        String jpql = "SELECT n FROM Nota n LEFT JOIN FETCH n.aluno_id LEFT JOIN FETCH n.diciplina_id WHERE n.aluno_id.id = :id";
